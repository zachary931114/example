package me.zhoubl.pay.common.service.aop;
...
public class LogExceptionAspect {
    ...
    @Pointcut("execution(* me.zhoubl.pay.*.service..*.*(..))")
...
//            logger.info("==>info class: " + joinPoint.getSignature().getDeclaringTypeName());
//            logger.info("==>info method: " + joinPoint.getSignature().getName());
//            logger.info("==>errCode:" + bizEx.getErrorCode() + " errMsg:" + bizEx.getMsg());
